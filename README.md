...
- **Authentication**: JWT Token-based with bcryptjs hashing (12 rounds)
...
- Password hashing with bcryptjs (12 rounds) for maximum security
...
- **better-sqlite3** - High-performance SQLite with synchronous API and advanced user relations
- **JWT** - JSON Web Tokens for stateless authentication
- **bcryptjs** - Military-grade password hashing (12 rounds) with pure JavaScript implementation
...
│   ├── database.js             # better-sqlite3 database with user relations & foreign keys
│   ├── package.json            # Node.js dependencies with better-sqlite3 & bcryptjs
...
# Install dependencies (includes better-sqlite3 for improved Windows compatibility)
npm install
...
4. **Version 4.0**: International email validation (200+ blocked domains)
...
- **Database optimization** with indexed user relations and foreign keys using better-sqlite3
...
## Recent Updates (v4.1)
- **Database Engine**: Upgraded to better-sqlite3 for improved performance and Windows compatibility
- **Password Hashing**: Enhanced with bcryptjs for pure JavaScript implementation  
- **Dependency Resolution**: Resolved native compilation issues for better deployment compatibility
- **Cross-Platform Support**: Eliminated node-gyp dependencies for seamless development across all operating systems
...
3. Test thoroughly with international email addresses
4. Commit your changes (`git commit -m 'Add amazing international feature'`)
5. Push to the branch (`git push origin feature/amazing-international-feature`)
